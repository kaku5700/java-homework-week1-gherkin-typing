Feature: Nopcommerce Registration
  ...
  Scenario Outline:  I should not be able to register with invalid data on mandatory field (*) of registration page
    ...
    Examples:
      ...
      | Mukesh     | ""        | patel@gmail.com | 123456   | 123456           | please enter Last Name                     |
      | Mukesh     | patel     | ""              | 123456   | 123456           | please enter valid email                   |
      | Mukesh     | patel     | patel@gmail.com | ""       | 123456           | password is required                       |
      | Mukesh     | patel     | patel@gmail.com | 123456   | ""               | confirm password is required               |
      | Mukesh     | patel     | patel@gmail.com | 123456   | 12345            | password and confirm password do not match |
      | Mukesh     | patel     | patel@gmail.com | 12345    | ""               | minimum 6 character password is required   |
  ...
  Scenario Outline: I should be select Day, Month and Year from drop down list of Date of birth field
  ...
  Scenario: I should be able to register with valid mandatory (*) field data on registration page
    When    I enter First name "Mukesh"
